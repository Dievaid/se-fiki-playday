    ...
    return (
        <>
            <div className="flex items-center space-x-4 text-3xl">
                <FaArrowTrendUp />
                <p className="font-semibold" ref={ref}>First Sale</p>
            </div>

            <p className="text-wrap w-1/2 sm:w-3/4 text-lg text-justify">
            ...
            <div className="flex items-center flex-col justify-center space-x-4 text-2xl gap-6">
                ...
                <p className="text-wrap w-1/2 sm:w-3/4 text-lg text-justify">Following The Mom Test principles allowed us to confirm that PlayDay addresses real pain points for players and field owners. Players were ready to adopt the app, while owners expressed interest with reservations about monetization details. These insights not only validate the MVP but also provide clear direction for refining our business model and expanding functionality to secure paying customers.</p>
            </div>
        </>
    );
}