    ...
    return (
        <>
            ...
            <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-y-[50px] gap-x-[5vw]">
                <TeamCard name="Sebastian Severin" desc="Project Manager" photo="/severin.sebastian.jpg"/>
                <TeamCard name="Iulia Olteanu" desc="UI/UX Analyst" photo="/olteanu.iulia.jpg"/>
                <TeamCard name="Bianca Șerban" desc="Business Analyst" photo="/serban.bianca.jpeg"/>
                ...
                <TeamCard name="Bogdan Brutaru" desc="Quality Assurance Engineer" photo="/brutaru.bogdan.jpg"/>
            </div>
        </>
    )
}